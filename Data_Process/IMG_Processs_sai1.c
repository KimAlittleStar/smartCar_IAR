...
void IMG_GetSign(){
   ...
   // PTE24_OUT=0;
    ...
    IMG_Forecast(); 
   /*if(IMG_FindPoint(0,0,1,79,WITHE)!=79)
   {
      ...
      for(y=40;y>15;y--)
            {
                if(BMP(5,y)==BLACK)
                {
                    ...
                    pointleft=0;
                    pointRight=0;
                    pointleft=IMG_FindPoint(0,y,1,79,WITHE); 
                    pointRight=79-IMG_FindPoint(pointleft,y,1,79,BLACK);
                ...
                if(BMP(75,y)==BLACK)
                {
                    ...
                    pointleft=0;
                    pointRight=0;
                    pointRight=IMG_FindPoint(79,y,1,0,WITHE); 
                    pointleft=IMG_FindPoint(pointRight,y,1,0,BLACK);
